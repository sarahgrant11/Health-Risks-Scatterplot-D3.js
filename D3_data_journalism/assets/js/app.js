...
// yText to select the group without excess code.
...
d3.csv("https://raw.githubusercontent.com/sarahgrant11/d3-challenge/master/D3_data_journalism/assets/data/Statedata.csv").then(function(data) {
  // Visualize the data
  visualize(data);
});
